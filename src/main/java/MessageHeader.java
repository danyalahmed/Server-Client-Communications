 ...
 * <p>
 * <p>You do <strong>NOT NEED TO IMPLEMENT THIS
 * YOURSELF</strong>. Instead the code is <a
 * href="/teaching/resources/CO2017/exercise3/MessageHeader.java">available
...
class MessageHeader {
  ...
  /**
   * Implement equals that requires both parts to be equal.
   *
